...
parser.add_option('-g', default='gene_tpm_matrix.csv', help="where to output the gene count matrix [default: %default")
parser.add_option('-t', default='transcript_tpm_matrix.csv', help="where to output the transcript count matrix [default: %default]")
